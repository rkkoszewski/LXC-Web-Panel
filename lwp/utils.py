...
cgroup_ext = {
    ...
    'utsname': ['lxc.uts.name', '^\w[\w.-]+$', 'Hostname updated'],
    'type': ['lxc.net.0.type', '^(none|empty|veth|vlan|macvlan|phys)$', 'Link network type updated'],
    'link': ['lxc.net.0.link', '^[\w.-/]+$', 'Link name updated'],
    'flags': ['lxc.net.0.flags', '^(up|down)$', 'Network flag updated'],
    'hwaddr': ['lxc.net.0.hwaddr', '^[0-9a-fA-F:]+$', 'Hardware address updated'],
    'ipv4': ['lxc.net.0.ipv4.addr', cidr_regex, 'IPv4 address updated'],
    'ipv4gw': ['lxc.net.0.ipv4.gateway', ip_regex, 'IPv4 gateway address updated'],
    'ipv6': ['lxc.net.0.ipv6.address', '^([0-9a-fA-F:/]+)+$', 'IPv6 address updated'],  # weak ipv6 regex check
    'ipv6gw': ['lxc.net.0.ipv6.gateway', '^([0-9a-fA-F:]+)+$', 'IPv6 gateway address updated'],
    'script_up': ['lxc.net.0.script.up', file_match, 'Network script down updated'],
    'script_down': ['lxc.net.0.script.down', file_match, 'Network script down updated'],
    'rootfs': ['lxc.rootfs.path', '^(\/|loop:\/|overlayfs:\/|dir:\/)[\w.\/:-]+$', 'Rootfs updated'],
    ...
    'loglevel': ['lxc.log.level', '^[0-9]$', 'Log level updated'],
    'logfile': ['lxc.log.file', file_match, 'Log file updated'],
